...
const NettestWhatsApp = (props: any) => (
  <Icon viewBox="0 0 30 30" {...props}>
    <g>
<g>
	<path d="M15.2,3.5c1.5,0,3,0.3,4.4,0.9c2.7,1.1,4.9,3.3,6,6c1.2,2.8,1.2,5.9,0,8.7c-1.1,2.7-3.3,4.8-6,6c-1.4,0.6-2.9,0.9-4.4,0.9
		...
		c0.7,0.6,1.4,1.1,2.3,1.5c0.1,0.1,0.2,0.1,0.3,0.1c0.1,0,0.4-0.2,0.8-0.7C17.9,16.4,18.1,16.2,18.2,16.2z"/>
</g>
</g>
  </Icon>
)
export default NettestWhatsApp
