...
Our color palette is adapted from [Open Color](https://yeun.github.io/open-color/)., an open-source color scheme. All hues apart Blue are taken as is from Open Color. The blue shades are adapted to include OONI's primary and secondary color.
