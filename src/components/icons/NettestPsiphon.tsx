...
const NettestPsiphon: IconType = (props) => (
  <IconBase viewBox="0 0 30 30" {...props}>
    <g>
      <g>
        <path
          id="Combined-Shape"
          d="M15,3.5c6.4,0,11.5,5.1,11.5,11.5S21.4,26.5,15,26.5S3.5,21.4,3.5,15S8.6,3.5,15,3.5z M20.4,7.4H9.3
