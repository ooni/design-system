...
const NettestWhatsApp: IconType = (props) => (
  <IconBase viewBox="0 0 30 30" {...props}>
    <g>
      <g>
        <path
          d="M15.2,3.5c1.5,0,3,0.3,4.4,0.9c2.7,1.1,4.9,3.3,6,6c1.2,2.8,1.2,5.9,0,8.7c-1.1,2.7-3.3,4.8-6,6c-1.4,0.6-2.9,0.9-4.4,0.9
