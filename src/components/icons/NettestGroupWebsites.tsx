...
const NettestGroupWebsites: IconType = (props) => (
  <IconBase viewBox="0 0 30 30" {...props}>
    <g>
      <title>Websites</title>
      <g>
        <path
          d="M20,17.3c0.1-0.8,0.2-1.5,0.2-2.3c0-0.8-0.1-1.5-0.2-2.3h3.9c0.2,0.8,0.3,1.5,0.3,2.3c0,0.8-0.1,1.5-0.3,2.3H20z M18,23.7
...
export default NettestGroupWebsites
