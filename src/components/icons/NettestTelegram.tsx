...
const NettestTelegram: IconType = (props) => (
  <IconBase viewBox="0 0 30 30" {...props}>
    <g>
      <g>
        <path
          id="Shape"
          d="M26.5,15c0,1.5-0.3,3.1-1,4.5c-1.2,2.8-3.3,4.9-6.1,6.1c-2.9,1.2-6.1,1.2-8.9,0c-2.7-1.2-4.9-3.3-6.1-6.1
...
export default NettestTelegram
